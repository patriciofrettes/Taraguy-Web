...
const Navbar = () => {
    ...
    const linkStyle = (path) => {
        ...
        return `relative group font-black uppercase tracking-wider text-sm md:text-base transition-colors duration-300 ${isActive ? 'text-white border-b-2 border-white' : 'text-gray-400 hover:text-white'}`;
    };
        ...
        <nav className="bg-black text-white border-b border-gray-900 sticky top-0 z-50 shadow-2xl">
            <div className="w-full px-6 md:px-10">
                <div className="flex justify-between items-center h-24">
                    ...
                    {/* SECCIÓN DERECHA: BOTÓN ASOCIATE */}
            ...
            {/* MENÚ MÓVIL */}
            {isOpen && (
                <div className="lg:hidden bg-zinc-900 transition-all duration-300">
